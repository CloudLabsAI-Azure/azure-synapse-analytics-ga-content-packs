...
$DataFactoryName = "asagadatafactory$($uniqueId)"
...
#Check for datafactory artifacts
Write-Output "Checing data factory artifacts"
$dfdatset1= "wwi02_sale_small_stats_adls"
$dfdatset2= "wwi02_sale_small_stats_asa"
$dfpipeline= "Lab 03 - Import Sales Stats"
$dfls1="asagadatalake01_adf"
$dfls2="asagakeyvault01_adf"
$dfls3="asagasqlpool01_adf"

$dfartifacts = @{
"dfpipelines" = Get-AzDataFactoryV2Pipeline -Name $dfpipeline -ResourceGroupName $resourceGroupName -DataFactoryName $DataFactoryName
"dflinkedservice1"= Get-AzDataFactoryV2LinkedService -Name $dfls1 -ResourceGroupName $resourceGroupName -DataFactoryName $DataFactoryName
"dflinkedservice2"=Get-AzDataFactoryV2LinkedService -Name $dfls2 -ResourceGroupName $resourceGroupName -DataFactoryName $DataFactoryName
"dflinkedservice3"=Get-AzDataFactoryV2LinkedService -Name $dfls3 -ResourceGroupName $resourceGroupName -DataFactoryName $DataFactoryName
"dfdataset1"=Get-AzDataFactoryV2Dataset -Name $dfdatset1 -ResourceGroupName $resourceGroupName -DataFactoryName $DataFactoryName
"dfdataset2"=Get-AzDataFactoryV2Dataset -Name $dfdatset2 -ResourceGroupName $resourceGroupName -DataFactoryName $DataFactoryName

}

if($dfartifacts.count -ne 6)
{
 $overallStateIsValid = $false
 Write-Warning "Data factory artifacts not found."
}
else{
  Write-Information "Data factory artifacts Ok"
}
